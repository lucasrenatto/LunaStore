...
namespace LunaStore.Domain.Entities
{
    public sealed class ProductEntity : BaseEntity
    {
        ...
        public ProductEntity(string name, string description, decimal price, int stock, string image)
        {
            ValidateDomain(name, description, price, stock, image);
        }

        public ProductEntity(int id, string name, string description, decimal price, int stock, string image)
        {
